...
class EditTextEmail : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        addTextChangedListener{ s ->
            ...
            if(!s.toString().matches(ObjectConstanta.emailPattern)){
                showErrorMessage("Masukkan Email yang sesuai")
            } else {
                hideError()
            }
        }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        context.apply {
            ...
            setHintTextColor(ContextCompat.getColor(this, R.color.md_theme_dark_onTertiary))
        }
        isSingleLine = true
